class SoftwareVersionsController < ApplicationController
  ...
  def index
    @software_versions = SoftwareVersion.order(:Software_Name,:Version_Number)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @software_version.save
        format.html { redirect_to @software_version, notice: 'Software version was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @software_version.update(software_version_params)
        format.html { redirect_to @software_version, notice: 'Software version was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to software_versions_url, notice: 'Software version was successfully destroyed.' }
  ...
  private
    ...
    def software_version_params
      params.require(:software_version).permit(:Software_Name, :Version_Number)
    end
end
