class WorkOrdersController < ApplicationController
  ...
  private
    ...
    def work_order_params
      params.require(:work_order).permit(:SAP_WorkOrder_Number, :ServiceMax_WorkOrder_Number, :instrument_id, :customer_id, :service_person_id, :details, :work_order_status_id, :Cost_SAP, :Cost_ServiceMax, :Short_Description)
    end
end
