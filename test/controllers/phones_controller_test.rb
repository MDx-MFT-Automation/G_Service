...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { Phone_Number: @phone.Phone_Number, contact_person_id: @phone.contact_person_id } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { Phone_Number: @phone.Phone_Number, contact_person_id: @phone.contact_person_id } }
