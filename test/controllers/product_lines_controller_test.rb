...
class ProductLinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create product_line" do
    assert_difference('ProductLine.count') do
      post product_lines_url, params: { product_line: { Product_Full_Name: @product_line.Product_Full_Name, Product_Name: @product_line.Product_Name } }
    end
  ...
  test "should update product_line" do
    patch product_line_url(@product_line), params: { product_line: { Product_Full_Name: @product_line.Product_Full_Name, Product_Name: @product_line.Product_Name } }
