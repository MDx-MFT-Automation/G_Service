...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post manufacturers_url, params: { manufacturer: { Chinese_Name: @manufacturer.Chinese_Name, English_Name: @manufacturer.English_Name } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { Chinese_Name: @manufacturer.Chinese_Name, English_Name: @manufacturer.English_Name } }
