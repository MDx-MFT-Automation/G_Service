...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { SAP_Complaint_Notification_Number: @complaint.SAP_Complaint_Notification_Number, Short_Description: @complaint.Short_Description, complain_status_id: @complaint.complain_status_id } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { SAP_Complaint_Notification_Number: @complaint.SAP_Complaint_Notification_Number, Short_Description: @complaint.Short_Description, complain_status_id: @complaint.complain_status_id } }
